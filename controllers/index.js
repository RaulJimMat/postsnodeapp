...
module.exports = {
  async landingPage(req,res, next){
    const postsArr = await Post.find({}).sort('-_id').exec();
    const recentPosts = postsArr.slice(0,3);
    res.render('index', {postsArr, mapBoxToken, recentPosts, title: 'Surf Shop - Home' });
  },
